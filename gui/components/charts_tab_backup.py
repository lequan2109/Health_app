...
class ChartsTab:
    ...
    def setup_control_panel(self):
        ...
        chart_types = [
            ...
            ("❤️ Phân bố Nhịp tim", "heart_rate_distribution"),
    ...
    def refresh_charts(self):
        ...
        try:
            ...
            if not weight_data and not activity_data and not sleep_data and not hr_data:
